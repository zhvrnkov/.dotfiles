(custom-set-variables
 ...
 '(package-selected-packages
   '(helm lsp-sourcekit flycheck lsp-mode projectile nasm-mode vterm ace-jump-mode paredit multiple-cursors multitran rust-mode browse-kill-ring visual-regexp-steroids visual-regexp undo-tree ido-vertical-mode ## yaml-mode plantuml-mode json-mode doom-themes swift-mode exec-path-from-shell magit gruber-darker-theme ido-completing-read+ haskell-mode smex markdown-mode))
