(custom-set-variables
 ...
 '(package-selected-packages
   '(glsl-mode evil lsp-haskell lsp-mode plantuml-mode magit gnu-elpa-keyring-update ivy yasnippet helm helm-lsp s projectile nasm-mode vterm ace-jump-mode paredit multiple-cursors multitran rust-mode browse-kill-ring visual-regexp-steroids visual-regexp undo-tree ido-vertical-mode ## yaml-mode json-mode doom-themes swift-mode exec-path-from-shell gruber-darker-theme ido-completing-read+ haskell-mode smex markdown-mode))
...
(custom-set-faces
 ...
 '(org-level-5 ((t (:foreground "#008080")))))
